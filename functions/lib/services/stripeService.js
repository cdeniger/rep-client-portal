...
const repStripe = new stripe_1.default(STRIPE_SECRET_KEY_REP || '', {
    apiVersion: '2023-10-16',
});
const cpfStripe = new stripe_1.default(STRIPE_SECRET_KEY_CPF || '', {
    apiVersion: '2023-10-16',
});
class StripeService {
    /**
     ...
     */
    async cancelRetainerSubscription(subscriptionId) {
     ...
     */
    async clonePaymentMethodToCpf(repPaymentMethodId, cpfCustomerId) {
     ...
     */
    async createIsaSubscription(customerId, priceId, paymentMethodId, startDate) {
        // Attach PM
